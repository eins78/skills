...
- **CLAUDE.md** — Repository conventions and skill authoring rules
  - Repository purpose and scope (documentation-only, no build/test/lint)
  - Skill format spec (SKILL.md frontmatter + markdown body)
  - Directory structure convention (SKILL.md + required README.md per skill)
