...
> **Graceful degradation:** For facilitators without deep reasoning capability (e.g., Haiku), skip the gap detection below. Instead: present the generated release notes to the user and ask "Do these release notes look complete?" Human review is the final gate regardless.
